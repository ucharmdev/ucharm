// template_build.zig - Template build.zig for Zig modules
//
...
pub fn build(b: *std.Build) void {
    ...
    // Create the module
    // CHANGE: Replace "template.zig" with your module name
    ...
    const obj = b.addObject(.{
        // CHANGE: Replace "template" with your module name
        .name = "template",
        .root_module = mod,
    });

    // Install the .o file to zig-out/
    // CHANGE: Replace "template.o" with your module name
    const install_obj = b.addInstallFile(obj.getEmittedBin(), "template.o");
